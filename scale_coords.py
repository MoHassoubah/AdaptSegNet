...
# # # for cnt in range(0, 4):
    ...
    # ####################
    # target_points_ids = np.where(depth <=65.0)
    # points = points[target_points_ids]
    # remissions = remissions[target_points_ids]
    # depth = depth[target_points_ids]
    # ####################
    ...
    if(points.shape[0] > max_points_scan):
...
print("max_points_scan = " + str(max_points_scan))
print("#points = " + str(num_points))
